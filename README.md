...
LRU (Least Recently Used):The idea behind LRU is that items that haven't been accessed recently are less likely to be used in the near future, so it's better to remove them from the cache to make room for more relevant data.  
